...
Worker publicado nesta rodada: `ade69238-3bb8-4149-b13f-c8467fcf0dfb`
...
Maturidade estimada: **90%**, com produção controlada. O núcleo do pedido interno e a operação administrativa estão funcionais, mas ainda não é correto declarar produção irrestrita: faltam App Check, domínio/alertas, dados operacionais finais, QR de mesa, instruções Pix completas, teste E2E de criação real controlado e teste concorrente de pedidos.

## Pontuação por critério

| Critério | Nota | Evidência e limite |
|---|---:|---|
| Funcionalidade | 9/10 | Pedido interno, reservas, conta, catálogo, operação de pedidos, promoções, caixa, finanças, horário e notificação de novos pedidos publicados; QR ainda pendente. |
...
- `npm run deploy:vinext` — Worker publicado na versão `ade69238-3bb8-4149-b13f-c8467fcf0dfb`.
