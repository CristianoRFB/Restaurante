...
import { formatMoney, getStoreAvailability, type MenuCategory, type MenuItem, type RestaurantSettings, type ServiceMomentId } from '@/shared/baru-domain';
import { useOrderCart } from '@/components/order-context';
import { readTableSession, writeTableSession } from '@/lib/order-repository';
...
export default function MenuPage() {
  ...
  const [tableId, setTableId] = useState(() => typeof window === 'undefined' ? '' : sanitizeTableId(new URLSearchParams(window.location.search).get('mesa')) || readTableSession());
