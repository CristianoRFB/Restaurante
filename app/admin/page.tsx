...
import { readReservations, readReservationsAsync } from '@/lib/baru-repository';
...
export default function AdminDashboardPage() {
  ...
  useEffect(() => { let active = true; readReservationsAsync().then((next) => { if (active) setItems(next); }).catch(() => { if (active) setError('Não foi possível sincronizar as reservas. Exibindo o último estado disponível.'); }); return () => { active = false; }; }, []);
